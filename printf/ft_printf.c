...
/*   Updated: 2023/01/03 16:41:44 by hyojocho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_width_check(char c, options *string)
{

}

void	ft_conversion(const char *format, size_t *index)
{
	options *string_info;
